...
cleanupObj = onCleanup(@cleanMeUp(arrayMatch, SerialPortOpened));
...
fileName = 'PTCal_test0';

% NAME THE FOLDER YOU WANT THE TEST TO BE IN
folderName = 'PTCal_testfold';
...
if serialPortOpened == 1
    ...
    function cleanMeUp(arrayMatch, serialPortOpened)
        if arrayMatch == 1 && serialPortOpened == 1
            ...
            prompt = "What is the pressure gauge reading? (Numbers only) \n";
